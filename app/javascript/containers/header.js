...
export class Header extends Component {
  ...
  render() {
    ...
    return (
      <nav
        id="header"
        className="navbar navbar-light navbar-expand-lg sticky-top bg-light"
      >
        <div className="container">
          <Link to="/" className="navbar-brand">
            <b>Ruby</b> China <sup>beta</sup>
          </Link>
          <button
          ...
          <div className="collapse navbar-collapse" id="main-nav-menu">
            <ul className="nav navbar-nav main-nav mr-auto">
            ...
            {!currentUser && (
              <ul className="nav navbar-nav">
                <li className="nav-item">
                  <a className="nav-link" href="/oauth/new">
                    登录
                  </a>
                </li>
              </ul>
